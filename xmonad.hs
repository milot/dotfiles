--------- Modified DT's xmonad.hs file for personal usage ---------
  -- Base
import XMonad
...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " vbox ", " chat ", " mus "]
...
myKeys =
    ...
    -- Toggle Monitor
    	, ("M-p l", spawn "/usr/bin/toggle-monitor")   -- toggles between monitors
    ...
    -- KB_GROUP Controls for mocp music player (SUPER-u followed by a key)
        , ("M-u p", spawn "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Play")
        , ("M-u l", spawn "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next")
        , ("M-u h", spawn "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Prev")
        , ("M-u <Space>", spawn "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause")
    ...
    -- KB_GROUP Multimedia Keys
        ...
        , ("<XF86AudioPrev>", spawn "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Prev")
